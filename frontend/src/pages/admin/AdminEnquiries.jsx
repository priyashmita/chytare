    ...
    <div data-testid="admin-enquiries">
      ...
      <div style={{ display: "flex", justifyContent: "space-between", marginBottom: "24px", flexWrap: "wrap", gap: "16px" }}>
        ...
        <div style={{ display: "flex", gap: "8px", alignItems: "center" }}>
          <ExportImportBar
            module="enquiries"
            filters={{ status: filterStatus, enquiry_source: filterSource, search }}
          />
          <button
      ...
      <div style={{ display: "flex", gap: "10px", marginBottom: "24px", flexWrap: "wrap" }}>
        {Object.entries(counts).map(([status, count]) => (
          <button
            ...
            style={{
              ...STATUS_STYLE[status],
              fontFamily: SANS, fontSize: "12px", padding: "6px 14px", letterSpacing: "0.05em",
              cursor: "pointer",
              border: filterStatus === status ? `1px solid ${STATUS_STYLE[status]?.color}` : "1px solid transparent",
            }}
          >
            {count} {status}
          </button>
              ...
              {filtered.map((e, i) => {
                ...
                return (
                  <tr key={e.id} style={{ borderTop: "1px solid rgba(218,203,160,0.15)", background: i % 2 === 0 ? "white" : "rgba(255,255,240,0.4)", cursor: "pointer" }}
                    ...
                    <td style={{ padding: "12px 16px" }}>
                      <span style={{ fontFamily: SANS, fontSize: "11px", background: sourceBg, padding: "3px 8px", textTransform: "capitalize", color: "rgba(27,77,62,0.7)" }}>
