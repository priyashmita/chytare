                  ...
                  <tbody>
                    {data?.production?.open_jobs_list?.map((job, i) => {
                      ...
                      return (
                        <tr
                          key={i}
                          style={{ borderTop: "1px solid rgba(218,203,160,0.1)", cursor: "pointer" }}
                          onClick={() => navigate("/admin/production-jobs")}
                        >
                          <td style={{ padding: "6px 8px", fontFamily: SANS, fontSize: "12px", fontWeight: 600, color: "#1B4D3E" }}>
                            {job.job_code}
                          </td>
                          <td
                            style={{
                          ...
                          <td
                            style={{
                              ...
                              fontFamily: SANS,
                              fontSize: "11px",
                              color: overdue ? "#C08081" : "rgba(27,77,62,0.6)",
                              fontWeight: overdue ? 600 : 400,
                            }}
                          >
                            {job.due_date
                              ? new Date(job.due_date).toLocaleDateString("en-IN", { day: "2-digit", month: "short" })
                              : "—"}
                          </td>
                          <td style={{ padding: "6px 8px" }}>
                            <span
                              style={{
                                ...
                                textTransform: "uppercase",
                                padding: "2px 6px",
                                background: job.status === "in_progress" ? "rgba(27,77,62,0.08)" : "rgba(218,203,160,0.2)",
                                color: job.status === "in_progress" ? "#1B4D3E" : "#8a7340",
                              }}
                            >
            ...
            <div style={{ overflowY: "auto", maxHeight: "180px" }}>
              {!data?.inventory?.finished_goods?.length ? (
                <p style={{ fontFamily: SANS, fontSize: "13px", color: "rgba(27,77,62,0.4)" }}>
                  No finished goods in inventory yet
                </p>
              ) : (
                <table style={{ width: "100%", borderCollapse: "collapse" }}>
                  <thead>
                    ...
                    {data?.inventory?.finished_goods
                      ...
                      .map((fg, i) => (
                        <tr key={i} style={{ borderTop: "1px solid rgba(218,203,160,0.1)" }}>
                          ...
                          <td style={{ padding: "6px 8px", fontFamily: SANS, fontSize: "11px", color: "rgba(27,77,62,0.5)" }}>
                            {fg.product_code}
                          </td>
                          <td style={{ padding: "6px 8px", fontFamily: SANS, fontSize: "13px", fontWeight: 600, color: "#1B4D3E" }}>
                            {fg.quantity}
                          </td>
                          <td style={{ padding: "6px 8px", fontFamily: SANS, fontSize: "11px", color: "rgba(27,77,62,0.5)" }}>
                            {fg.location || "—"}
            ...
            {!loading && data?.inventory?.low_stock_count > 0 && (
              <span
                style={{
                  fontFamily: SANS,
                  fontSize: "11px",
                  background: "rgba(192,128,129,0.15)",
                  color: "#C08081",
                  padding: "1px 8px",
                }}
              >
                {data.inventory.low_stock_count} alert{data.inventory.low_stock_count !== 1 ? "s" : ""}
              </span>
            )}
          </div>
                ...
                data?.inventory?.low_stock?.map((m, i) => (
                  <div
                    ...
                    style={{
                      ...
                      alignItems: "center",
                      padding: "8px 0",
                      borderBottom: "1px solid rgba(218,203,160,0.1)",
                    }}
                  >
                    <div>
                      ...
                      <p style={{ fontFamily: SANS, fontSize: "11px", color: "rgba(27,77,62,0.4)" }}>
                        {m.material_code} · {m.material_type}
                      </p>
                    </div>
                    <span
                      style={{
        ...
        <div style={{ display: "flex", gap: "10px", flexWrap: "wrap", marginBottom: "8px" }}>
          {data?.orders?.by_status?.map((s, i) => {
            ...
            return (
              <div
                key={i}
                onClick={() => navigate(`/admin/orders?status=${s.status}`)}
                style={{
                  background: "white",
                  border: "1px solid rgba(218,203,160,0.3)",
                  padding: "12px 20px",
              ...
              >
                <span style={{ fontFamily: SERIF, fontSize: "22px", color: colors[s.status] || "#1B4D3E" }}>
                  {s.count}
                </span>
                <span
                  style={{
            ...
            data?.top_products?.top_selling?.map((p, i) => (
              ...
              >
                <div style={{ display: "flex", alignItems: "center", gap: "10px" }}>
                  <span style={{ fontFamily: SERIF, fontSize: "16px", color: "rgba(218,203,160,0.7)", minWidth: "20px" }}>
                    {i + 1}
                  </span>
                  <div>
                ...
                <div style={{ textAlign: "right" }}>
                  ...
                  <p style={{ fontFamily: SANS, fontSize: "11px", color: "rgba(27,77,62,0.5)" }}>
          ...
          {loading ? (
            ...
            data?.top_products?.most_enquired?.map((p, i) => (
              ...
              >
                ...
                <span style={{ fontFamily: SANS, fontSize: "13px", fontWeight: 600, color: "#3a4a9a" }}>
                  {p.count} enquiries
                </span>
              </div>
            ))
