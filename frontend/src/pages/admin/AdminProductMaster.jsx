...
<div style={{ display: "flex", gap: "10px" }}>
            <button onClick={handleImport} disabled={importing} className="btn-luxury btn-luxury-secondary" style={{ whiteSpace: "nowrap", opacity: importing ? 0.6 : 1 }}>
                ...
                {filtered.map((p, i) => {
                  ...
                  return (
                    <tr key={p.id} style={{ borderTop: "1px solid rgba(218,203,160,0.15)", background: i % 2 === 0 ? "white" : "rgba(255,255,240,0.4)" }}>
                      ...
                      <td style={{ padding: "12px 16px" }}>
                        <span style={{ ...statusStyle, fontFamily: SANS, fontSize: "11px", letterSpacing: "0.08em", textTransform: "uppercase", padding: "3px 8px", fontWeight: 500 }}>
                          {p.status}
                        </span>
                      </td>
                      <td style={{ padding: "12px 16px" }}>
