...
const AdminLayout = () => {
  ...
  const pagesMenuItems = [{ name: "About Page", path: "/admin/pages/about" }];
      ...
      >
        <div className="flex flex-col h-full">
          <div className="p-6 border-b border-[#FFFFF0]/10">
            <Link to="/admin">
              <img src="/assets/logo-gold.png" alt="Chytare Admin" className="h-10 brightness-110" />
            </Link>
          </div>
          ...
          <nav className="flex-1 p-4 space-y-1 overflow-y-auto text-[#FFFFF0]">
            {mainMenuItems.map((item) => {
              ...
              const isActive =
                ...
                (item.path.includes("?tab=") && location.pathname === "/admin/settings");
          ...
          <div className="p-4 border-t border-[#FFFFF0]/10">
            <div className="px-4 py-2 mb-2">
              <p className="text-xs" style={{ color: "rgba(255, 255, 240, 0.5)" }}>
                {user?.email}
              </p>
              <p className="text-sm capitalize" style={{ color: "#DACBA0" }}>
                {user?.role}
              </p>
            </div>
            <button
